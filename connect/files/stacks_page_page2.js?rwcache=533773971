...
stacks.stacks_in_2_page2 = {};
stacks.stacks_in_2_page2 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery; stacks.totalRequestHeaders={'Total-Key':$.trim('')};

return stack;})(stacks.stacks_in_2_page2);
stacks.stacks_in_9_page2 = {};
stacks.stacks_in_9_page2 = (function(stack) {
...
function keepPage(){
  var thisSF3H = $('#stacks_in_9_page2-sf').find('.slider');
...
function initSF3(){
  var thisSF3 = $('#stacks_in_9_page2-sf');
  ...
  if(sfThumbs >= 1 && 1 == 0 ){
    ...
    thisSF3.find('.carousel').flexslider({
      ...
      asNavFor: '#stacks_in_9_page2-sf .slider'
    });
    ...
    thisSF3.find('.slider').addClass('thumbs').flexslider({
      ...
      sync: "#stacks_in_9_page2-sf .carousel"
    });
  }else{
  ...
  thisSF3.find('.slider .flex-control-paging').appendTo('#stacks_in_9_page2-sf');
}
...
return stack;})(stacks.stacks_in_9_page2);
stacks.stacks_in_15_page2 = {};
stacks.stacks_in_15_page2 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;// Start doo Tab 2 stack each Javascript code$(document).ready(function() {		// generate the top tabs list	var stacks_in_15_page2x = 1;	$("#stacks_in_15_page2 .uk_co_doobox_dootab2item_stack").each(function(){		var thisId = "stacks_in_15_page2tab" + stacks_in_15_page2x;		var thisTabName = $(this).find(".dooTabContentTitle").html();		$(".stacks_in_15_page2tabs").append('<li class="" rel="' + thisId + '">' + thisTabName + '</li>');		$(this).find(".dooTabContent").attr("id",thisId);		$(this).find(".tab_drawer_heading").attr("rel",thisId).html(thisTabName);		stacks_in_15_page2x++;	});	    //$("#stacks_in_15_page2 .dooTabContent").slideUp();    $("#stacks_in_15_page2 .dooTabContent:first").slideDown();    $(".stacks_in_15_page2tabs li:first").addClass("active");    $(".tab_drawer_heading:first").addClass("stacks_in_15_page2_active");        /* if in tab mode */    $("ul.stacks_in_15_page2tabs li").click(function() {		      $("#stacks_in_15_page2 .dooTabContent").slideUp();      var activeTab = $(this).attr("rel");       $("#"+activeTab).slideDown();				      $("ul.stacks_in_15_page2tabs li").removeClass("active");      $(this).addClass("active");	  $(".tab_drawer_heading").removeClass("stacks_in_15_page2_active");	  $(".tab_drawer_heading[rel^='"+activeTab+"']").addClass("stacks_in_15_page2_active");	      });    	/* if in drawer mode */	$(".tab_drawer_heading").click(function() {            $("#stacks_in_15_page2 .dooTabContent").slideUp();      var stacks_in_15_page2_activeTab = $(this).attr("rel");       $("#"+stacks_in_15_page2_activeTab).slideDown();	  	  $(".tab_drawer_heading").removeClass("stacks_in_15_page2_active");      $(this).addClass("stacks_in_15_page2_active");	  	  $("ul.stacks_in_15_page2tabs li").removeClass("active");	  $("ul.stacks_in_15_page2tabs li[rel^='"+stacks_in_15_page2_activeTab+"']").addClass("active");	  	  if($("#stacks_in_15_page2").offset().top < $(document).scrollTop()){		    $("body").animate({			    scrollTop: $("#stacks_in_15_page2").offset().top			}, 300);	  }    });			/* Extra class "tab_last" 	   to add border to right side	   of last tab */	$('ul.stacks_in_15_page2tabs li').last().addClass("tab_last");	$('ul.stacks_in_15_page2tabs li').first().addClass("tab_first");	});// End doo Tab 2 stack each Javascript code
return stack;})(stacks.stacks_in_15_page2);