...
stacks.stacks_in_2_page3 = {};
stacks.stacks_in_2_page3 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery; stacks.totalRequestHeaders={'Total-Key':$.trim('')};

return stack;})(stacks.stacks_in_2_page3);
stacks.stacks_in_15_page3 = {};
stacks.stacks_in_15_page3 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;/*
...
function keepPage(){
  var thisSF3H = $('#stacks_in_15_page3-sf').find('.slider');
...
function initSF3(){
  var thisSF3 = $('#stacks_in_15_page3-sf');
  ...
  if(sfThumbs >= 1 && 1 == 0 ){
    ...
    thisSF3.find('.carousel').flexslider({
      ...
      asNavFor: '#stacks_in_15_page3-sf .slider'
    });
    ...
    thisSF3.find('.slider').addClass('thumbs').flexslider({
      ...
      sync: "#stacks_in_15_page3-sf .carousel"
    });
  }else{
  ...
  thisSF3.find('.slider .flex-control-paging').appendTo('#stacks_in_15_page3-sf');
}
...
return stack;})(stacks.stacks_in_15_page3);
stacks.stacks_in_45_page3 = {};
stacks.stacks_in_45_page3 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(function() {

  var thisABSwitch = $('#ab-switch-stacks_in_45_page3');
  var aSwitch = thisABSwitch.next();
  var bSwitch = thisABSwitch.next().next();
  var abSwitch = thisABSwitch.find('li.ab-option');
  var bHash = thisABSwitch.data('hash');

  thisABSwitch.find('.ab-toggle:checkbox').on('click',function() {
    var $this = $(this);
    if ($this.is(':checked')) {
      $(this).parent().toggleClass('ncd-toggle-switch');
      abSwitch.add(bSwitch).add(aSwitch).toggleClass('show');
    }else{
      $(this).parent().toggleClass('ncd-toggle-switch');
      abSwitch.add(bSwitch).add(aSwitch).toggleClass('show');
    }
  });
  if ( window.location.hash == '#' + bHash ||  thisABSwitch.data('default') == '1') {
    window.location.hash = ' ';
    thisABSwitch.find('.ab-toggle:checkbox').trigger('click');
  }
  abSwitch.on('click',function() {
    if(!$(this).hasClass('show')){ thisABSwitch.find('.ab-toggle:checkbox').trigger('click'); }
  });
  if(thisABSwitch.data('hover') == '1'){
    abSwitch.on('mouseover',function() {
      if(!$(this).hasClass('show')){ thisABSwitch.find('.ab-toggle:checkbox').trigger('click'); }
    });
  }
});
return stack;})(stacks.stacks_in_45_page3);