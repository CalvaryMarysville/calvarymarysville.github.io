...
return stack;})(stacks.stacks_in_2_page0);
...
function keepPage(){
  var thisSF3H = $('#stacks_in_3_page0-sf').find('.slider');
...
function initSF3(){
  var thisSF3 = $('#stacks_in_3_page0-sf');
  ...
  thisSF3.find('.sf3-slide').each(function(index,element){
    ...
    if($(this).hasClass('hero')){
      ...
      $(this).find('h2').css({
        '-webkit-transition-delay:': (100 + h2Delay)+'ms',
        'transition-delay': (100 + h2Delay)+'ms'
      });
      $(this).find('p').css({
        '-webkit-transition-delay:': (100 + pDelay)+'ms',
        'transition-delay': (100 + pDelay)+'ms'
      });
      $(this).find('a').css({
        '-webkit-transition-delay:': (100 + linkDelay)+'ms',
        'transition-delay': (100 + linkDelay)+'ms'
      });
  ...
  if(sfThumbs >= 1 && 1 == 0 ){
    ...
    thisSF3.find('.carousel').flexslider({
      ...
      asNavFor: '#stacks_in_3_page0-sf .slider'
    });
    ...
    thisSF3.find('.slider').addClass('thumbs').flexslider({
      ...
      sync: "#stacks_in_3_page0-sf .carousel"
    });
  }else{
  ...
  thisSF3.find('.slider .flex-control-paging').appendTo('#stacks_in_3_page0-sf');
}
...
stacks.stacks_in_97_page0 = {};
stacks.stacks_in_97_page0 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;/*
 * jQuery appear plugin
 * Copyright (c) 2012 Andrey Sidorov
 * licensed under MIT license.
...
function keepPage(){
  var thisSF3H = $('#stacks_in_97_page0-sf').find('.slider');
...
function initSF3(){
  var thisSF3 = $('#stacks_in_97_page0-sf');
  var slidesSF3 = thisSF3.find('.slider .slides');
  var thumbnailsSF3 = thisSF3.find('.carousel .slides');
  var sfThumbs = 0;
  ...
  if(sfThumbs >= 1 && 1 == 0 ){
    ...
    thisSF3.find('.carousel').flexslider({
      ...
      asNavFor: '#stacks_in_97_page0-sf .slider'
    });
    ...
    thisSF3.find('.slider').addClass('thumbs').flexslider({
      ...
      sync: "#stacks_in_97_page0-sf .carousel"
    });
  }else{
    thisSF3.find('.slider').flexslider({
  ...
  thisSF3.find('.slider .flex-control-paging').appendTo('#stacks_in_97_page0-sf');
}
...
return stack;})(stacks.stacks_in_97_page0);
stacks.stacks_in_71_page0 = {};
stacks.stacks_in_71_page0 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(function(){ $("#stacks_in_71_page0 img").one("load", function() {  $(this).addClass('show'); }).each(function() { if(this.complete) $(this).load(); }); });

return stack;})(stacks.stacks_in_71_page0);