...
stacks.com_elixir_stacks_structure = {};
stacks.com_elixir_stacks_structure = (function(stack) {
...
return stack;})(stacks.com_elixir_stacks_structure);
...
stacks.stacks_in_10_page1 = {};
stacks.stacks_in_10_page1 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery; stacks.totalRequestHeaders={'Total-Key':$.trim('')};

return stack;})(stacks.stacks_in_10_page1);
stacks.stacks_in_11_page1 = {};
stacks.stacks_in_11_page1 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;/*
...
function keepPage(){
  var thisSF3H = $('#stacks_in_11_page1-sf').find('.slider');
...
function initSF3(){
  var thisSF3 = $('#stacks_in_11_page1-sf');
  ...
  if(sfThumbs >= 1 && 1 == 0 ){
    ...
    thisSF3.find('.carousel').flexslider({
      ...
      asNavFor: '#stacks_in_11_page1-sf .slider'
    });
    ...
    thisSF3.find('.slider').addClass('thumbs').flexslider({
      ...
      sync: "#stacks_in_11_page1-sf .carousel"
    });
  }else{
  ...
  thisSF3.find('.slider .flex-control-paging').appendTo('#stacks_in_11_page1-sf');
}
...
return stack;})(stacks.stacks_in_11_page1);
stacks.stacks_in_97_page1 = {};
stacks.stacks_in_97_page1 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;// Start doo Tab 2 stack each Javascript code$(document).ready(function() {		// generate the top tabs list	var stacks_in_97_page1x = 1;	$("#stacks_in_97_page1 .uk_co_doobox_dootab2item_stack").each(function(){		var thisId = "stacks_in_97_page1tab" + stacks_in_97_page1x;		var thisTabName = $(this).find(".dooTabContentTitle").html();		$(".stacks_in_97_page1tabs").append('<li class="" rel="' + thisId + '">' + thisTabName + '</li>');		$(this).find(".dooTabContent").attr("id",thisId);		$(this).find(".tab_drawer_heading").attr("rel",thisId).html(thisTabName);		stacks_in_97_page1x++;	});	    //$("#stacks_in_97_page1 .dooTabContent").slideUp();    $("#stacks_in_97_page1 .dooTabContent:first").slideDown();    $(".stacks_in_97_page1tabs li:first").addClass("active");    $(".tab_drawer_heading:first").addClass("stacks_in_97_page1_active");        /* if in tab mode */    $("ul.stacks_in_97_page1tabs li").click(function() {		      $("#stacks_in_97_page1 .dooTabContent").slideUp();      var activeTab = $(this).attr("rel");       $("#"+activeTab).slideDown();				      $("ul.stacks_in_97_page1tabs li").removeClass("active");      $(this).addClass("active");	  $(".tab_drawer_heading").removeClass("stacks_in_97_page1_active");	  $(".tab_drawer_heading[rel^='"+activeTab+"']").addClass("stacks_in_97_page1_active");	      });    	/* if in drawer mode */	$(".tab_drawer_heading").click(function() {            $("#stacks_in_97_page1 .dooTabContent").slideUp();      var stacks_in_97_page1_activeTab = $(this).attr("rel");       $("#"+stacks_in_97_page1_activeTab).slideDown();	  	  $(".tab_drawer_heading").removeClass("stacks_in_97_page1_active");      $(this).addClass("stacks_in_97_page1_active");	  	  $("ul.stacks_in_97_page1tabs li").removeClass("active");	  $("ul.stacks_in_97_page1tabs li[rel^='"+stacks_in_97_page1_activeTab+"']").addClass("active");	  	  if($("#stacks_in_97_page1").offset().top < $(document).scrollTop()){		    $("body").animate({			    scrollTop: $("#stacks_in_97_page1").offset().top			}, 300);	  }    });			/* Extra class "tab_last" 	   to add border to right side	   of last tab */	$('ul.stacks_in_97_page1tabs li').last().addClass("tab_last");	$('ul.stacks_in_97_page1tabs li').first().addClass("tab_first");	});// End doo Tab 2 stack each Javascript code
return stack;})(stacks.stacks_in_97_page1);